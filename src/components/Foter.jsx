  ...
  return (
    <div>
      <div className='w-full bg-[#0099B5] pb-12 mt-18 px-4'>
        <p className='text-2xl sm:text-3xl md:text-4xl text-white text-center pt-12 font-bold'>BIZ BILAN BOG'LANISH</p>

        <div className='flex flex-col sm:flex-row sm:flex-wrap sm:justify-around items-center mt-12 gap-8'>
          <div className='text-white text-center sm:text-left w-[250px]'>
            <h1 className='text-xl font-semibold'>Manzil:</h1>
        ...
        <div className="w-full max-w-[1200px] mx-auto relative h-[400px] sm:h-[500px] rounded-lg shadow-lg mt-10">
          <iframe
      ...
      <div className='w-full bg-blue-800 px-4 py-12'>
        <div className='max-w-[1200px] mx-auto grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 text-white'>
          <div>
            <p className='text-lg font-semibold mb-2'>Asosiy sahifa</p>
            <h1>Bitiruvchilar</h1>
            <h1>Intarnet</h1>
            <h1>Elektron pochta</h1>
          </div>
          <div>
            <p className='text-lg font-semibold mb-2 invisible sm:visible'>&nbsp;</p>
            <h1>Virtual sayohat</h1>
            <h1>Tez-tez so'raladigan savollar</h1>
            <h1>Talabalar</h1>
          </div>
          <div>
            <p className='text-lg font-semibold mb-2'>Fanlar</p>
            <h1>Anqi fanlar</h1>
            <h1>Tabiiy fanlar</h1>
            <h1>Xorij fanlari</h1>
          </div>
          <div>
            <p className='text-lg font-semibold mb-2'>Tezkor so'rovlar</p>
            <h1>Biz haqimizda</h1>
            <h1>Ish o'rinlari</h1>
